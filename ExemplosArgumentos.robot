...
*** Variable ***
&{PESSOA}       nome=Rafael Silva   email=rafael.silva@exemplo.com.br   idade=33   sexo=masculino
...
*** Keywords ***
Uma keyword qualquer 01
    Uma subkeyword com argumentos   Rafael Silva   rafael.silva@teste.com.br
